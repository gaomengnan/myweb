...
<a class="btn btn-primary" href="<?php echo U('User/index','','');?>"> 返回</button>
...
<label>密码</label>
        ...
        <label>选择身份</label>
<input value="管理员" name="status" type="radio" checked>管理员
<input value="普通用户" name="status" type="radio" >普通用户
