...
<div class="btn-toolbar">
    ...
    <button   href="<?php echo u('User/export','','');?>"  id="export">导出</button><div  style="display:none;" id="heh">
<br><form action="<?php echo u('User/export');?>" method="post"><select id="select1" name="select" >
...
<td><?php echo ($v["status"]); ?></td>
  <td>
              ...
              <a href="<?php echo u('User/edit',array('id'=>$v['id']),'');?>"><i class="icon-pencil"></i></a>
...
var url = '<?php echo U('User/delete',array('id'=>$v['id']),'');?>';
location.href = url;
}else{
