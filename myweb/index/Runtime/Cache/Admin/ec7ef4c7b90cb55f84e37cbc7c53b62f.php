...
<?php if(ACTION_NAME == "addtitlelist" ): ?><!--<a href="<?php echo u('User/edit',array('id'=>$v['id']),'');?>"><i class="icon-pencil"></i></a>
-->
<a href="<?php echo U('Exam/deletetotrach',array('id'=>$v['id'],'type'=>1),'');?>" role="button" data-toggle="modal"><i class="icon-remove"></i></a>
<?php else: ?>
<a href="<?php echo U('Exam/deletetotrach',array('id'=>$v['id'],'type'=>0),'');?>">还原</a>
<a href="<?php echo U('Exam/realdel',array('id'=>$v['id']),'');?>">彻底删除</a><?php endif; ?>
  </td>
