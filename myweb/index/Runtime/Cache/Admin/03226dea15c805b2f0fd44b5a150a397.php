        ...
        <div class="row-fluid">
            <div class="span3">
                ...
                <ul id="accounts-menu" class="nav nav-list collapse in">
                  <a href="<?php echo U('Exam/addtitlelist','','');?>">试卷列表</a></li>
...
<form id="tab" action="<?php echo U('Exam/runaddtitle');?>" method="post">
<div class="btn-toolbar">

    <button id="save" type="submit"  class="btn btn-primary"><i class="icon-save"></i> 提交</button>
<a class="btn btn-primary" href="<?php echo U('Exam/addtitlelist','','');?>"> 返回</button>
...
<option >====请选择分类==== </option>
<?php if(is_array($res)): foreach($res as $key=>$v): ?><option value="<?php echo ($v["id"]); ?>"><?php echo ($v["html"]); echo ($v["name"]); ?></option><?php endforeach; endif; ?>
<select>        
<label>题目标题</label>

        <input type="text"  name="title"  value="" class="input-xlarge">

<span class="error" >题目名称不能为空！</span>
<label>题目内容</label>
...
<script id="container" name="content" type="text/plain" style="width:920px;height:300px;">
<p>
...
<p>
  ...
  <!-- 编辑器源码文件 -->
  <script type="text/javascript" src="/myweb/Public/ueditor/ueditor.all.js"></script>
  <!-- 实例化编辑器 -->
